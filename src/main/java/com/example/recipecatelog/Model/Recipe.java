 ...
 * needs), the catalog entries it uses ({@link RecipeIngredient}, any of which may
 * be optional or replaceable), and tags.
 *
 * <p>All cross-service references are by id. {@code ingredientId} points into the
 * Ingredient catalog; {@code recipeId} (on a replacement) points back into this
 * catalog. No foreign keys cross the service boundary.
 *
